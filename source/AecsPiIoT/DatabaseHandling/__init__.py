...
#            sql = 'create table if not exists settings (name text primary key not null, data text not null;)'
    ...
    def LayoutPiRevision3():
        ...
        c.execute("INSERT INTO `tblgpiolayout` (physical,bcm,wpi,name,inuse) VALUES (7,4,7,'GPIO. 7',0);")
